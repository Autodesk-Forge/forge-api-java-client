...
public class Hubs   {
  ...
  @JsonProperty("data")
  private List<Hub> data = new ArrayList<Hub>();

  public Hubs jsonapi(JsonApiVersionJsonapi jsonapi) {
  ...
  **/
  ...
  public Hubs data(List<Hub> data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public void setData(List<Hub> data) {
    this.data = data;
  }
