...
import com.autodesk.client.model.Storage;
...
public class StorageCreated   {
  ...
  public StorageCreated jsonapi(JsonApiVersionJsonapi jsonapi) {
  ...
  **/
  ...
  public StorageCreated data(Storage data) {
    this.data = data;
    return this;
  }
  ...
  **/
  ...
  public StorageCreated included(List<JsonApiResource> included) {
