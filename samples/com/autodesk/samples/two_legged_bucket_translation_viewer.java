...
public class two_legged_bucket_translation_viewer{
    ...
    private static ObjectDetails uploadFile() throws FileNotFoundException, ApiException, Exception {
        ...
        ApiResponse<ObjectDetails> response = objectsApi.uploadObject(BUCKET_KEY, FILE_NAME,
    ...
    private static void openViewer(String base64Urn) throws IOException {
        ...
        //Desktop.getDesktop().browse may probably trim the query parameters of the url,
        //may copy the string to browser address box to test  manually
        //or setup a local server
        System.out.print(builder.build().toURL());
    }
    ...
    private static void deleteFile() throws ApiException, Exception {
        ...
        ApiResponse<Void> response = objectsApi.deleteObject(BUCKET_KEY, FILE_NAME, oauth2TwoLegged,
